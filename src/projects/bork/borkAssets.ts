import bgFarmyard from "./assets/bg_farmyard-2DArH9p5.png";
import bgBarn from "./assets/bg_barn--D-jnsn9.png";
import bgHayField from "./assets/bg_hay_field-DCLAHH_N.png";
import bgWindmillHill from "./assets/bg_windmill_hill-DH2RKPRz.png";
import bgChickenCoop from "./assets/bg_chicken_coop-D956Gf_c.png";
import bgVegetableGarden from "./assets/bg_vegetable_garden-CZnrlzg6.png";
import bgFarmhousePorch from "./assets/bg_farmhouse_porch-Bvxu0EbF.png";

import actorRussToire from "./assets/actor_russ_toire-C7S_Fy0h.png";
import actorRussToire_idle_0 from "./assets/actor_russ_toire_idle_0-ijm6YvXy.png";
import actorRussToire_idle_1 from "./assets/actor_russ_toire_idle_1-Be2vOwoV.png";
import actorRussToire_walk_0 from "./assets/actor_russ_toire_walk_0-El23-HfR.png";
import actorRussToire_walk_1 from "./assets/actor_russ_toire_walk_1-By7tXB69.png";
import actorOldHen from "./assets/actor_old_hen-BeyOI0B3.png";
import actorDuck from "./assets/actor_duck-BDA_nMZ0.png";
import actorGoat from "./assets/actor_goat-s-brdVy2.png";
import actorHens from "./assets/actor_hens-HJBMhQ5G.png";
import actorRabbit from "./assets/actor_rabbit-BD6yhYyN.png";
import actorCat from "./assets/actor_cat-DR6Z3510.png";

import objScarecrow from "./assets/obj_scarecrow-uryoy7Qd.png";
import objCultBucket from "./assets/obj_cult_bucket-DwDnwLK-.png";
import objHayPile from "./assets/obj_hay_pile-DzZmjG1L.png";
import objBarnTools from "./assets/obj_barn_tools-C_4I3BFq.png";
import objHayBale from "./assets/obj_hay_bale-4NIpzSTC.png";
import objFencePost from "./assets/obj_fence_post-DTZCiCjg.png";
import objWindmill from "./assets/obj_windmill-BLh7tfnn.png";
import objWindmillLadder from "./assets/obj_windmill_ladder-B7mNcbIc.png";
import objNestBoxes from "./assets/obj_nest_boxes-Ms6hwVFl.png";
import objFeatherPile from "./assets/obj_feather_pile-Crg-qdbh.png";
import objGardenRows from "./assets/obj_garden_rows-BWNNuB1J.png";
import objWateringCan from "./assets/obj_watering_can-BfDrQ09c.png";
import objGloveHook from "./assets/obj_glove_hook-DLPoBtwu.png";
import objPorchChair from "./assets/obj_porch_chair-DHR5_cZT.png";

import itemStrawHat from "./assets/item_straw_hat-HVYN_yxE.png";
import itemLeatherGloves from "./assets/item_leather_gloves-U6GixZli.png";
import itemPlaidShirt from "./assets/item_plaid_shirt-CGtOsNPY.png";
